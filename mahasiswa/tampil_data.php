            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                <tr>
                    ...
                    <td width="120" class="center">
                        ...
                        <a title="Hapus" class="btn btn-outline-danger" href="proses_hapus.php?nim=<?php echo $data['nim'];?>" onclick="return confirm('Anda yakin ingin menghapus mahasiswa <?php echo $data['nama_mahasiswa']; ?>?');"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            <?php
                $no++;
